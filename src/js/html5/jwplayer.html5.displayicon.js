    ...
    html5.displayicon = function(_id, _api, textStyle, textStyleOver) {
        ...
        this.setText = function(text) {
           ...
           // style.textAlign='left';
            if (text) {// "<font style='color:#f01400;font-size:16px;'>已结束</font>刷新"
               
              /* 
               var t1="<font style='color:#ffffff;font-size:16px;'>咦？加载失败了！</font> <br> ";
                //刷新   mouseover:ff4d4d;
               // var t44="<font style='color:#f01400;font-size:14px;onmouseover='txtOver(this)'  onmouseout='txtOut(this)' >意见反馈 </a></font>";
                var t4="<font style='color:#f01400;font-size:14px;<a href='http://www.imooc.com/user/feedback'>意见反馈 </a></font>";
                var t2="<font style='color:#f01400;font-size:14px; id='page_reload'>刷新 </font>";
                
                var t3="<font style='color:#787d82;font-size:12px/2em '> 或者换个浏览器试试！<br> 还是无法观看？请提交 ";
                _text.innerHTML ="<p> " + t1 + "</p>" + "<p>"+t2+t3+ t4+" </p>"; //
*/
               // _text.innerHTML =text.replace(':', '<br>');
               _text.innerHTML='';
             }
