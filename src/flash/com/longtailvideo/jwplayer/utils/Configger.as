package com.longtailvideo.jwplayer.utils {
	...
	public class Configger extends EventDispatcher {
		...
		public static var  _playAuto:Boolean=false;
		...
		*/
		...
		public static function getPlayAutoCookie():Boolean{
			var cookie:SharedObject = SharedObject.getLocal('com.longtailvideo.jwplayer','/');
			
			var playAuto:Boolean=true;
			if(cookie.data.playAuto=="undefined"){
				playAuto=false;
			}else{
				playAuto=cookie.data.playAuto;
			}
			//playAuto=_config[playAuto];
			return playAuto;
		}
