package com.longtailvideo.jwplayer.view.interfaces {
	...
	public interface IControlbarComponent extends IPlayerComponent {
		...
		function bigTimeSlider():void;
		function smallTimeSlider():void;//Controlbar
		function bigControlbar():void;
		function smallControlbar():void;//
		function showVolumeOverlay2():void;
		function controlbarIsBig():Boolean;
		function hideVolumeOverlay2():void
	}
}