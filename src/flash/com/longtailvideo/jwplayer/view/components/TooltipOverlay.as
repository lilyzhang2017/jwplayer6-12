package com.longtailvideo.jwplayer.view.components
{
	...
	public class TooltipOverlay extends MovieClip {
		...
		public function TooltipOverlay(skin:ISkin, inverted:Boolean=false) {
			...
			_text.defaultTextFormat = new TextFormat("_sans", 14, textFormat.color, textFormat.bold, null, null, null, null, TextFormatAlign.CENTER, 5, 5);
			_text.visible = false;
